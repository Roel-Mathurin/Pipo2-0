                ...
                {isOpen && (
                    <div >
                        <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                            ...
                            <Link to="/prelegend" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">MEMBRES DE LEGEND LEGACY FC</Link>
                            <Link to="/galerielegend" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">GALERIE DE LEGEND LEGACY FC</Link>
                        </div>
                    </div>
                )}
            </div>
